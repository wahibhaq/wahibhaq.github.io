...
My name is Wahib. I'm a passionate android developer, product enthusiast, community advocate, and someone who takes keen interest in more than just the coding side of a mobile app. I am currently working as a <strong>Lead Partner Engineering</strong> at <a href="https://developer.huawei.com/consumer/en/" target="_blank">Huawei</a> and leading initiatives that are aimed at contributing towards Huawei's vision of building a global mobile ecosystem. Our #DevRel team is striving to bring HMS Core tech closer to partners, developers, and end users.
