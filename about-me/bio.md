...
My name is Wahib, I'm a passionate android developer, product enthusiast, community advocate, and someone who takes keen interest in more than just the coding side of a mobile app. I am currently working as an <strong>Senior Developer Advocate</strong> at <a href="https://developer.huawei.com/consumer/en/" target="_blank">Huawei</a> and leading initiatives which are aimed at contributing towards the vision of building a sustainable ecosystem. Our #DevRel team is striving to bring tech closer to partners, developers and users.
